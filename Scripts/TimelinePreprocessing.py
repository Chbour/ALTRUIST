...
class PreprocessTimeline(object):
    ...
    def __init__(self, dict_key_concept, keywords_to_match):
        self.key_concept = dict_key_concept
        self.keywords = keywords_to_match
    ...
    def defineT0(self, timeline, threshold, model): 
        """
